...
vec2 poisson_disk[SAMPLES] = vec2[]( vec2(-0.94201624, -0.39906216), 
...
float get_shadow(vec3 norm, vec3 light_dir_norm)
{
    ...
    return shadow/SAMPLES; //Return the averaged shadow factor (over the number of samples in the for loop).
