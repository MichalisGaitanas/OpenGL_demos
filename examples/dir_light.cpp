...
const char *winLabel = "Directional light calculations";
...
int main()
{
    ...
    mesh sphere("../models/smooth/sphere.obj", 1,1,1);
    shader shad("../shaders/trans_mvpn.vert","../shaders/dir_light_ads.frag");
    shad.use();

    glm::vec3 lightDir; //light direction in world coordinates
    ...
    glm::vec3 camPos = glm::vec3(0.0f,-5.0f,2.0f); //camera position in world coordinates
    ...
    shad.set_vec3_uniform("camPos", camPos);
    ...
    while (!glfwWindowShouldClose(window)) //game loop
    {
        ...
        lightDir = glm::vec3(cos(glfwGetTime()),sin(glfwGetTime()),0.0f); //light direction in world coordinates
        shad.set_vec3_uniform("lightDir", lightDir);
