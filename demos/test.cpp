...
int main()
{
    ...
    shader shad_dir_light_with_shadow("../shaders/vertex/trans_mvpn_shadow.vert","../shaders/fragment/oren.frag");
    ...
    float ang_vel_z = 0.000f; //[rad/sec]
    float fov = 45.0f; //[deg]
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shad_dir_light_with_shadow.set_vec3_uniform("cam_pos", cam_pos);
